...
type (ADT) or data structure. This structure
simulates a hierarchical tree with a root  
and subtrees, represented as 
a set of linked nodes.

A tree data structure can be defined recursively (locally) 
as a collection of nodes (starting at the root node). Each node is a data structure consisting of a value, 
and a list of references the subtrees (the "children"), 
